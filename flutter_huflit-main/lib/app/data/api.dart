...
class APIRepository {
  ...
  Future<bool> addBill(List<Cart> products, String token, double total, {required String paymentMethod}) async {
    var list = [];
    try {
  ...
  forgotPassword(String text, String text2, String text3) {}
  saveOrder(double total, String paymentMethod, String bank, String token) {}
}
